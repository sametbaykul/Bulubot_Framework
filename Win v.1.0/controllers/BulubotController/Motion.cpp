...
class Motion
{
  ...
  private:
    ...
    bool _active;
    bool _run;
    int _current_motion_index = -1;
    int _current_frame_index = -1;
    int _step_counter = -1;
    int _step_A = -1;
    int _step_B = -1;
    void (*_call_back)();
...
void Motion::NEW_MOTION(int Motion_Index, int Total_Frame, int Frame_Interval, double Speed)
{
  ...
  if (Motion_Index >= TOTAL_MOTION_TYPES)
  {
    ...
    TRACE("X - ERROR: NEW_MOTION() method parameter 'Motion_Index' should be less than FineTunning parameter 'TOTAL_MOTION_TYPES'");
  }
  ...
  if (Total_Frame >= TOTAL_MOTION_FRAME)
  {
    ...
    TRACE("X - ERROR: NEW_MOTION() method parameter 'Total_Frame' should be less than FineTunning parameter 'TOTAL_MOTION_FRAME'");
  }
...
void Motion::SET_MOTION_FRAME(int Motion_Index, int Frame_Index, FRAME Frame)
{
  ...
  if (Frame_Index >= TOTAL_MOTION_FRAME)
  {
    ...
    TRACE("X - ERROR: NEW_MOTION() method parameter 'Frame_Index' should be less than FineTunning parameter 'TOTAL_MOTION_FRAME'");
  }
